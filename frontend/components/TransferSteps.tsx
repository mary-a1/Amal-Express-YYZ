...
export default function TransferSteps({ finalPayAmount }: TransferStepsProps) {
  return (
    <>
      ...
      <div className="bg-[#0D0C1D] text-white py-3 px-4 sm:py-3  sm:px-6 lg:px-8 lg:py-5">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-300 mb-2 text-base sm:text-lg max-w-3xl mx-auto">
            Sending money with Amal Transfers is simple, transparent, and secure.
          </p>
          <p className="text-center text-gray-300 mb-12 text-base sm:text-lg max-w-3xl mx-auto">
            Follow these steps to complete your transfer in minutes.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="border-2 border-orange-500 rounded-xl p-6 sm:p-8 bg-[#0D0C1D]">
              <h3 className="text-lg sm:text-xl font-bold mb-3">1. Enter your amount</h3>
            ...
            <div className="border-2 border-orange-500 rounded-xl p-6 sm:p-8 bg-[#0D0C1D]">
              <h3 className="text-lg sm:text-xl font-bold mb-3">2. E-transfer your total</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <div className="border-2 border-orange-500 rounded-xl p-6 sm:p-8 bg-[#0D0C1D] md:col-span-2 lg:col-span-1">
              <h3 className="text-lg sm:text-xl font-bold mb-3">3. We deliver your funds</h3>
              <p className="text-xs text-gray-500 mt-3 italic">
                Once received, we process and confirm your transfer. ✨ For support, call <strong>416-245-0805</strong>.
              </p>
